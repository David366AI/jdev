...
import com.jdev.parser.TokenStreamException;
import com.jdev.parser.TokenStreamIOException;
import com.jdev.parser.TokenStreamRecognitionException;
import com.jdev.parser.CharStreamException;
import com.jdev.parser.CharStreamIOException;
import com.jdev.parser.ANTLRException;
import java.io.Reader;
import java.util.Hashtable;
import com.jdev.parser.CharScanner;
import com.jdev.parser.InputBuffer;
import com.jdev.parser.ByteBuffer;
import com.jdev.parser.CharBuffer;
import com.jdev.parser.Token;
import com.jdev.parser.CommonToken;
import com.jdev.parser.RecognitionException;
import com.jdev.parser.NoViableAltForCharException;
import com.jdev.parser.MismatchedCharException;
import com.jdev.parser.TokenStream;
import com.jdev.parser.ANTLRHashString;
import com.jdev.parser.LexerSharedInputState;
import com.jdev.parser.collections.impl.BitSet;
import com.jdev.parser.SemanticException;
public class JavaLexer extends com.jdev.parser.CharScanner implements JavaTokenTypes, TokenStream
 {
...
tryAgain:
	...
	//System.exit(1);
	JavaRecognizer.errorMsg = JavaRecognizer.errorMsg + "CharScanner: Error" + "\n";
    }
    public void panic(String s) {
		System.err.println("CharScanner; panic: "+s);
		//System.exit(1);
		JavaRecognizer.errorMsg = JavaRecognizer.errorMsg + "CharScanner: "+ s + "\n";	
    }
}
