...
import com.jdev.parser.TokenBuffer;
...
import com.jdev.parser.LLkParser;
import com.jdev.parser.Token;
import com.jdev.parser.TokenStream;
import com.jdev.parser.RecognitionException;
import com.jdev.parser.NoViableAltException;
import com.jdev.parser.MismatchedTokenException;
import com.jdev.parser.SemanticException;
import com.jdev.parser.ParserSharedInputState;
import com.jdev.parser.collections.impl.BitSet;
import com.jdev.parser.collections.AST;
import com.jdev.parser.ASTPair;
import com.jdev.parser.collections.impl.ASTArray;
 ...
 *
 * $Id: //depot/code/org.com.jdev.parser/release/com.jdev.parser-2.7.0/examples/java/java/java.g#1 $
 *
 * BUG:
 ...
 */
public class JavaRecognizer extends com.jdev.parser.LLkParser
...
public void reportError(String s) {
    if (getFilename() == null) {
        ...
        errorMsg = errorMsg + "warning: " + s + "\n";
    } else {
        System.err.println(getFilename() + ": error: " + s);
        errorMsg = errorMsg + getFilename() + "warning: " + s + "\n\r";
    }
}
